...
const Footer = () => {
  ...
  return (
    // <footer className="bg-[#5BC8AC] text-white py-8 z-40 relative">
    //   <div className="container mx-auto px-6 lg:px-14 flex flex-col lg:flex-row lg:justify-between items-center gap-4">
    //     <div className="text-center lg:text-left">
    //       <h2 className="text-3xl font-bold mb-2">EZ Short</h2>
    //       <p>EZ Short URL shortening for efficient sharing</p>
    //     </div>

    //     <p className="mt-4 lg:mt-0">
    //       &copy; 2024 EZ Short. All rights reserved.
    //     </p>
  ...
  <footer className="w-full text-gray-700 bg-gray-200 body-font mt-3">
    <div className="container flex flex-col flex-wrap px-5 py-24 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap">
      <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
        ...
        <p className="mt-2 text-sm text-gray-500">URL Shortening Made Easy</p>
        <div className="mt-4">
    ...
    <div className="bg-gray-400">
      <div className="container px-5 py-4 mx-auto">
        <p className="text-sm text-gray-700 capitalize xl:text-center">
         EZ Shorts © {year} All rights reserved{" "}
        </p>
      </div>
    </div>
  </footer>
